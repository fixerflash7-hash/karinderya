...
-- PEPSI UI INIT
local pepsi = loadstring(game:GetObjects("rbxassetid://7657867786")[1].Source)()
local Window = pepsi:CreateWindow({
...
local IngredientsTab = Window:CreateTab({ Name = "Ingredients" })
local PlayerTab = Window:CreateTab({ Name = "Player" })
local SettingsTab = Window:CreateTab({ Name = "Settings" })
local ModsTab = Window:CreateTab({ Name = "Mods" })
...
mainSection1:AddToggle({ Name = "Auto Serve Food", Value = false, Callback = function(v) Config.autoServe = v end })
mainSection1:AddToggle({ Name = "Auto Assign Customers", Value = false, Callback = function(v) Config.autoOrder = v end })
mainSection1:AddToggle({ Name = "Auto Serve Drinks", Value = false, Callback = function(v) Config.autoSoftdrinks = v end })
mainSection1:AddToggle({ Name = "Auto Reject Selected Rarities", Value = false, Callback = function(v) Config.autoRejectNPC = v end })

-- Dropdown for reject rarities
local rejectDropdown = mainSection1:AddDropdown({ Name = "Reject Rarities", Value = {}, Callback = function(selected)
...
mainSection2:AddToggle({ Name = "Auto Wash Dishes", Value = false, Callback = function(v) Config.autoWash = v end })
mainSection2:AddToggle({ Name = "Auto Pan", Value = false, Callback = function(v) Config.autoPan = v end })

local mainSection3 = MainTab:CreateSection({ Name = "Auto Trash" })
mainSection3:AddToggle({ Name = "Auto TP & Instant CLEAN", Value = false, Callback = function(v)
    Config.autoTP = v
...
mainSection4:AddToggle({ Name = "Auto Claim Codes", Value = false, Callback = function(v) Config.autoClaimCodes = v end })

local mainSection5 = MainTab:CreateSection({ Name = "Furniture & Menu" })
mainSection5:AddToggle({ Name = "Auto Unlock Menu", Value = false, Callback = function(v) Config.autoUnlockMenu = v end })
...
playerSection1:AddToggle({ Name = "Infinite Jump", Value = false, Callback = function(v) Config.infJump = v end })
playerSection1:AddToggle({ Name = "NoClip", Value = false, Callback = function(v)
    Config.noclip = v
    setNoclip(v)
end })
...
modsSection:AddToggle({ Name = "Instantly leaves when staff or higher ups join", Value = false, Callback = function(v)
    Config.antiMod = v
    if v then
...
configSection:AddParagraph({ Name = "Pepsi UI", Content = "Pepsi UI interface with saved element flags" })
...
ingredientsSection1:AddToggle({ Name = "Auto Buy", Value = false, Callback = function(v) Config.autoBuyIngredients = v end })
...
-- Tables
shopSection1:AddToggle({ Name = "Auto Buy Table", Value = false, Callback = function(v) autoBuyTables = v end })
...
-- Chairs
shopSection1:AddToggle({ Name = "Auto Buy Chair", Value = false, Callback = function(v) autoBuyChairs = v end })
...
-- Materials
shopSection1:AddToggle({ Name = "Auto Buy Material", Value = false, Callback = function(v) autoBuyMaterials = v end })
...
-- Paints
shopSection1:AddToggle({ Name = "Auto Buy Paint", Value = false, Callback = function(v) autoBuyPaints = v end })
...
-- Tiles
shopSection1:AddToggle({ Name = "Auto Buy Tile", Value = false, Callback = function(v) autoBuyTiles = v end })
...
-- Stoves
shopSection1:AddToggle({ Name = "Auto Buy Stove", Value = false, Callback = function(v) autoBuyStoves = v end })
